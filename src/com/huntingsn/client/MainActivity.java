...
public void attemptLogin() {
	...
	if (cancel) {
		...
		showProgress(true);
		//RESTClientUsage client = new RESTClientUsage(new WeakReference<Activity>(this), new WeakReference<EditText>(mPasswordView));
		//String result = client.login(mEmail, mPassword);
...
public class UserLoginTask extends AsyncTask<Void, Void, String> {
	...
	protected String doInBackground(Void... params) {
		...
		return RESTHTTPClient.post("login", loginParams);
	}
	...
	protected void onPostExecute(final String success) {
		...
		String userId = "";
		String userName = "";
		if (success != null && success != "Wrong user or password") {
